...
{   
    ...
    //Espera o usuário digitar qualuer tecla
    getch();       
    system("pause");      
}
...
void Imprime(int *p){
     int a,b,c=1;
     for(a=0;a<9;a++){//Mostra os numeros
     printf("    %i",c);
     if(a==2||a==5)printf("\n\n");
     c++;
     }
